...
Se encuentra a un costado derecho del logotipo de GitHub y es de navegacion Global, ya que puedes acceder a las diferentes opciones que te brinda el site.


### 2. Botones Pull requests, Issuees, Marketplace y Explore:
![Menu_local.png](assets\images\Menu_local.png)

Se encuentran en al lado del Input mencionado en el punto uno, y son de navegacion local.


### 3. Botones + e imagen de perfil:
![more_profile.png](assets\images\more_profile.png)

Se encuentran del lado superior derecho de la pagina y son de NAvegacion local.

### 4. Opciones Browse activity y Discover repositories:

![Browse_activity_Discover_reporitories.png](assets\images\Browse_activity_Discover_reporitories.png)

Son de navegacion Facetada. Al seleccionar "Discover repositories" se encuentra la navegacion Suplementaria para sugerirte un uso adecuado de la seccion, ademas que se encuentra inline la invitacion en Explorar más (Explore).Acontinuacion despues de este aparece la navegacion contextual que te brinda reomendaciones de repositorios.

### 5. Your repositories (Find a repository).

![Your_repositories.png](assets\images\Your_repositories.png)

Navegacion local y debajo del input Find a repositories navegacion facetada, justo debajo de estas opciones navegacion contextual. Esta seccion es de elementos conocidos.
